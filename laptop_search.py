...
e = Extractor.from_yaml_file('laptop_search.yml')
...
# product_data = []
with open("laptop_search_urls.txt", 'r') as urllist, open('laptop_search_output.jsonl', 'w+') as outfile:
    f = open('laptop_product_urls.txt','w')
