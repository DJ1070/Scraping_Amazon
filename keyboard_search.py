...
e = Extractor.from_yaml_file('keyboard_search.yml')
...
# product_data = []
with open("keyboard_search_urls.txt", 'r') as urllist, open('keyboard_search_output.jsonl', 'w+') as outfile:
    f = open('keyboard_product_urls.txt','w')
