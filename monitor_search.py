...
e = Extractor.from_yaml_file('monitor_search.yml')
...
# product_data = []
with open("monitor_search_urls.txt", 'r') as urllist, open('monitor_search_output.jsonl', 'w+') as outfile:
    f = open('monitor_product_urls.txt','w')
