...
e = Extractor.from_yaml_file('mouse_search.yml')
...
# product_data = []
with open("mouse_search_urls.txt", 'r') as urllist, open('mouse_search_output.jsonl', 'w+') as outfile:
    f = open('mouse_product_urls.txt','w')
