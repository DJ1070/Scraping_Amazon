...
e = Extractor.from_yaml_file('camera_search.yml')
...
# product_data = []
with open("camera_search_urls.txt", 'r') as urllist, open('camera_search_output.jsonl', 'w+') as outfile:
    f = open('camera_product_urls.txt','w')
